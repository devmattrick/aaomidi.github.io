...
function doyourthang(watch) {
    build("Gem.browser", watch, {name: 'Gem', output: {path: __dirname + '/../../dist/', name: "Gem.umd.js"}})
    build("Gem.browser", watch, {
        name: 'Gem',
        minify: false,
        output: {path: __dirname + '/../../dist/', name: "Gem.dev.umd.js"}
    })
    build("test/all.tests", watch, {name: 'allTests', minify: false, output: {path: __dirname + '/../test/generated/'}})
    build("test/performance.tests", watch, {
        name: 'performanceTests',
        minify: false,
        output: {path: __dirname + '/../test/generated/'}
    })
}
